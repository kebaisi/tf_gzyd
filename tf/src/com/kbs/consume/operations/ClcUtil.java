...
public static byte getXor(byte[] datas){
	...
	public static String getSt(String val){
		...
		byte [] dd =  new byte[message.length];
		 ...
		 String s = ClcUtil.decToHex(ClcUtil.CRC_XModem(dd))+val;
		 String length = icUtils.hexTwoData(Integer.toHexString(s.length()/2));
		 if(length.length()!=4){
			 length=length+"00";
		 }
		
		 return result+length+s+"03";
	}
...
//	 System.out.println("st000---:"+st);
		System.out.println(getSt("0500270004010000"));
